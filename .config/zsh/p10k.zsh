# Generated by Powerlevel10k configuration wizard on 2024-03-05 at 11:46 CET.
...
# 2 lines, disconnected, full frame, darkest-ornaments, compact, few icons, concise,
...
() {
  ...
  # Show job count even when there's only 1 job.
  ...
  # show hostname only when remote
  function prompt_context() {
    if [[ -n "$SSH_CLIENT" ]]; then
      p10k segment -f 180 -t '%n@%m'
    fi
  }
