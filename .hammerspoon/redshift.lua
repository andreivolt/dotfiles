...
function redshift.init()
  ...
  hs.hotkey.bind({'alt', 'shift'}, 'up', function() changeTemp('+100') end)
  hs.hotkey.bind({'alt', 'shift'}, 'down', function() changeTemp('-100') end)
  hs.alert.show('Redshift temperature controls bound to Option+Shift+Up (warmer) and Option+Shift+Down (cooler)', {textSize=16}, 3)
end
